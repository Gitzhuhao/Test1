...
/**
 * Created by Administrator on 2016/9/8 0008. 封装获取各种请求链接的工具类：
 */
public class CommonUrls {
	...
	public String getTestUrl() {
		return "http://c.m.163.com/nc/article/C5GL25V100058783/full.html";
		// return "http://www.tianheonline.com/";
	}
	...
	public String getHotCommentUrl(String docid) {
		return "http://comment.news.163.com/api/v1/products/a2869674571f77b5a0867c3d71db5856/threads/" + docid
				+ "/comments/hotTopList?";
	}
